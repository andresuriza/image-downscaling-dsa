...
module mi_sdram_mm_interconnect_0 (
	...
	mi_sdram_mm_interconnect_0_router router (
	...
	mi_sdram_mm_interconnect_0_router_001 router_001 (
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (sdram_clk_clk_clk_clk),                                         //       cr0.clk
	...
	mi_sdram_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sdram_clk_clk_clk_clk),                                    //       clk.clk
		.reset              (new_sdram_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mi_sdram_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sdram_clk_clk_clk_clk),                                    //       clk.clk
		.reset               (new_sdram_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mi_sdram_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (sdram_clk_clk_clk_clk),                                         //       clk.clk
		.reset              (new_sdram_controller_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	mi_sdram_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sdram_clk_clk_clk_clk),                                    //       clk.clk
		.reset               (new_sdram_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mi_sdram_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (sdram_clk_clk_clk_clk),                                    // in_clk_0.clk
