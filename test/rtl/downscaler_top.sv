...
module downscaler_top #(
    ...
    // Debug outputs
    //=======================================================
    output logic [3:0]  dbg_fsm_state_out,
    output logic [15:0] dbg_out_x_out,
    output logic [15:0] dbg_out_y_out,
    output logic [2:0]  dbg_batch_size_out
);
    ...
    //=======================================================
    // Internal SIMD signals (declare before use)
    //=======================================================
    ...
    assign dbg_fsm_state_out = dbg_fsm_state;
    assign dbg_out_x_out = dbg_out_x;
    assign dbg_out_y_out = dbg_out_y;
    assign dbg_batch_size_out = dbg_batch_size;
